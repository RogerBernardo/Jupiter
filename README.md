...
[Editor MD](https://pandao.github.io/editor.md/en.html) - Edite os readmes da vida aqui

[JSON to Dart](https://javiercbk.github.io/json_to_dart/) - Converta JSON para a linguagem Dart
...
[Ui gradients](https://uigradients.com/#KyeMeh) - Gradientes para utilizar em projetos

[Bootstrap](https://getbootstrap.com/) - O Framework css mais conhecido e utilizado pelo mercado

[Inspiração para interfaces](https://interfaces.convertux.com/)

[Adobe color](https://color.adobe.com/pt/create) - Gerador de paletas de cores

[Fontsquirrel](https://www.fontsquirrel.com/) - Banco de fontes

[FontFabric](https://www.fontfabric.com/) - Banco de fontes

[Flat Design](http://www.fltdsgn.com/) - Boas referências de websites usando o estilo flat.

[Flat Gallery](http://flatinspire.com/) - Flat Inspire é uma galeria que mostra os melhores websites que arrasam no flat design/ UI style.

[Flat UI](http://designmodo.github.io/Flat-UI/) - Interface com elementos Flat UI totalmente free.

[Logopond](https://logopond.com/) - Um excelente site de referências de logos, de todos os tipos.

[The Best Designs](https://www.thebestdesigns.com/) - The Best Designs é uma galeria de design. Eles não apenas exibem designs de várias indústrias, mas também os sites das agências e os temas pré-fabricados que eles apresentam. É um bom lugar para checar os padrões mais recentes do mercado.

[Site Inspire](https://www.siteinspire.com/) - Busque inspirações de sites aqui.
...
[Estrutura de dados e algoritmos em Javascript](https://github.com/trekhleb/javascript-algorithms)

[A arte do comando em linha](https://github.com/jlevy/the-art-of-command-line)

[Design de sistemas](https://github.com/donnemartin/system-design-primer)

[Templates de gitignore](https://github.com/github/gitignore)

[Faça sua própria tecnologia](https://github.com/danistefanovic/build-your-own-x) - Aprenda a construir sua própria tecnologia

[Developer Roadmap](https://github.com/kamranahmedse/developer-roadmap) - Não sabe o que estudar ou o que você deve saber pra seguir na área de desenvolvimento?
